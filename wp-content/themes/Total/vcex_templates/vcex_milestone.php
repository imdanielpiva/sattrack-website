	...
	$output .= '<div class="vcex-milestone-inner">';
		...
		$output .= '<div class="vcex-milestone-desc">';
			...
			$output .= '<div class="vcex-milestone-number"'. $number_style .'>';
				...
				$output .= '<span class="vcex-milestone-time" data-start-val="0" data-end-val="'. floatval( do_shortcode( $number ) ) .'" data-duration="'. intval( $speed ) .'" data-decimals="'. intval( $decimals ) .'" data-separator="'. esc_attr( $separator ) .'" data-decimal="'. esc_attr( $decimal ) .'">0</span>';
