							...
							$output .= '>';
								...
								if ( 'true' == $position
									...
									$output .= '<div class="staff-entry-position"'. $position_style .'>';
										...
										$get_position = wp_kses_post( $get_position );

										$output .= apply_filters( 'wpex_staff_entry_position', $get_position );
								...
								if ( 'true' == $social_links ) :
									...
									$output .= '<div class="staff-entry-social-links wpex-clr"'. $social_links_inline_css .'>';
								...
								if ( 'true' == $read_more && $read_more_text ) :
									...
									$output .= '<div class="staff-entry-readmore-wrap entry-readmore-wrap clr">';
										...
										$output .= '<a href="'. $atts['post_permalink'] .'" rel="bookmark" class="'. $readmore_classes .'"'. $readmore_style . $readmore_data . vcex_html( 'target_attr', $link_target ) .'>';
